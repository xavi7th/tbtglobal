...
if (!function_exists('ajax_upload_image')) {
	/**
	 * Function to handle base64 encoded image uploads
	 *
	 * @param string $image_payload base64 encoded image stream
	 * @param string $storage_location Folder name to store image in
	 * @return String the image name to store in DB
	 *
	 **/
	function ajax_upload_image($image_payload, $storage_location)
	{
		$data = $image_payload;
		$foldername = $storage_location;
