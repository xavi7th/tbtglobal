                                                        ...
                                                        <tr>
                                                            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    style="border-collapse: separate !important;border-radius: 3px;background-color: #004281;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" valign="middle"
                                                                                class="mcnButtonContent"
                                                                                style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                                                                <a class="mcnButton " title="REPLY"
                                                                                    href="mailto:{{ $email }}"
                                                                                    target="_blank"
                                                                                    style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">REPLY</a>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
