...
<script>
  import {
    ...
    Fa as mdbIcon,
    Tbl as mdbTbl,
    BarChart as mdbBarChart,
    PieChart as mdbPieChart,
    LineChart as mdbLineChart,
    RadarChart as mdbRadarChart,
    DoughnutChart as mdbDoughnutChart,
    ListGroup as mdbListGroup,
    ListGroupItem as mdbListGroupItem,
    Badge as mdbBadge,
    Modal as mdbModal,
    ModalHeader as mdbModalHeader,
    ModalTitle as mdbModalTitle,
